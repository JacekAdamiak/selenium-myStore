    ...
    public WebDriver getBrowser() {
        ...
        if (isRemoteRun) {
            ...
            switch (browserType) {
                ...
                case IE:
                    System.setProperty("webdriver.ie.driver", LocalWebDriverProperties.getInternetExplorerDriverLocation());
                    return new InternetExplorerDriver();
                case EDGE:
                    System.setProperty("webdriver.edge.driver", LocalWebDriverProperties.getEdgeDriverLocation());
